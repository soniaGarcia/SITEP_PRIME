package sv.gob.mh.siteputil.util.jsf;
...
import sv.gob.mh.sitepcommon.util.enums.SuppressWarningEnum;
...
public class JsfUniversalConverter implements Converter {
     ...
     */
    //private static final Logger LOG = LoggerFactory.getLogger(JsfUniversalConverter.class);
...
//                + returnObject);
     ...
     */
    @SuppressWarnings(SuppressWarningEnum.UNCHECKED)

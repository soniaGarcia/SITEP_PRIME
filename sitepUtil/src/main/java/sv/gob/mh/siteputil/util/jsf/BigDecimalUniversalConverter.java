...
@FacesConverter("bigDecimalUniversalConverter")
public class BigDecimalUniversalConverter implements Converter {
	private static final BigDecimal UPPER_LIMIT = new BigDecimal(999999999);
	private static final BigDecimal LOWER_LIMIT = new BigDecimal(-999999999);
